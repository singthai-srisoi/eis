...
<!--begin::Heading-->
<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Purchase</h1>
<!--end::Heading-->
                                ...
                                <table id="myTable" class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary d-block fs-6">{{ $tb_purchaserequest->tb_approval->a_desc }}</a>
                                            </td>
