                  ...
                  <div class="card card-xl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #F7D9E3">
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <div class="d-flex flex-column flex-grow">
                        <!--begin::Title-->
                        <span class="text-dark fw-bold fs-3">Weekly Earnings</span>
                        <!--end::Title-->
                        <!--begin::Chart-->
                        <!--end::Chart-->
                      </div>
                      ...
                      <div class="pt-4">
                        <!--begin::Symbol-->
                        @foreach($weeklyProfit as $data)
                        <span class="text-dark fw-bold fs-2x lh-0">RM</span>
                        <!--end::Symbol-->
                        <!--begin::Number-->
                        <span class="text-dark fw-bold fs-2x me-2 lh-0">{{ number_format($data->weekly_profit, 2) }}</span>
                        @endforeach
                        <!--end::Number-->
                        <!--begin::Text-->
                        <!--end::Text-->
                  ...
                  <div class="card card-xxl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #CBF0F4">
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        <!--begin::Title-->
                        <span class="text-dark fw-bold fs-3">Top 3 Product</span>
                        <!--end::Title-->
                      </div>
                      <!--end::Wrapper-->
                      <!--begin::Stats-->
                      <div class="pt-5">
                        ...
                        <span class="text-dark fw-bold fs">{{ $loop->iteration }}. </span>
                        <span class="text-dark fw-bold fs">{{ $product->product }}</span>
                        <br>
                        @endforeach
                        <!--end::Number-->
                        <!--begin::Text-->
                  ...
                  <div class="card card-xxl-stretch mb-5 mb-xl-10 theme-dark-bg-body" style="background-color: #CBD4F4">
                    ...
                    <div class="card-body d-flex flex-column">
                      ...
                      <div class="d-flex flex-column mb-7">
                        <!--begin::Title-->
                        <span class="text-dark fw-bold fs-3">Summary</span>
                        <!--end::Title-->
                      </div>
                      <!--end::Wrapper-->
                      <!--begin::Row-->
                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-6">
                          <div class="d-flex align-items-center mb-9 me-2">
                            ...
                            <!--begin::Title-->
                            <div>
                              <div class="fs-5 text-dark fw-bold lh-1">RM {{ number_format($data->total_sales, 2) }}</div>
                        ...
                        <div class="col-6">
                          <div class="d-flex align-items-center mb-9 ms-2">
                            ...
                            <!--begin::Title-->
                            <div>
                              <div class="fs-5 text-dark fw-bold lh-1">RM {{ number_format($data->total_profit, 2) }}</div>
                        ...
                        <div class="col-6">
                          <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <div>
                              <div class="fs-5 text-dark fw-bold lh-1">{{ number_format($data->profit_growth, 2) }}%</div>
                        ...
                        <div class="col-6">
                          <div class="d-flex align-items-center ms-2">
                            ...
                            <!--begin::Title-->
                            <div>
                              <div class="fs-5 text-dark fw-bold lh-1">{{ $data->total_order }} </div>
