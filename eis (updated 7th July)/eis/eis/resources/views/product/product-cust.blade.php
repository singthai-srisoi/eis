...
<div class="content d-flex flex-column flex-column-fluid" id="p_content">
	...
	<div class="container-xxl" id="p_content_container">
		...
		<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
			<!--begin::Heading-->
			<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Categories</h1>
			<!--begin::Breadcrumb-->
			<ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
				<li class="breadcrumb-item text-muted">
					<a href="{{url('product-cust')}}" class="text-muted">All Categories</a>
				</li>
				...
				<div class="row g-10">
					...
					<div class="col-md-4">
						...
						<div class="card-xl-stretch me-md-6">
							...
							<div class="mt-5">
								<!--begin::Title-->
								<a href="{{ url('product-details', $p->prod_id)}}" class="fs-4 text-dark fw-bold text-hover-primary text-dark lh-base" style="white-space: nowrap; overflow: hidden; max-width: 100%; display: inline-block;">{{$p['prod_name']}}</a>
								<!--end::Title-->
								<!--begin::Text-->
