            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('purchase_order.update',$purchaseOrder->po_id) }}" method="POST" id="kt_invoice_form">
                            @csrf
                            @method('PUT')
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-column align-items-start flex-xxl-row">
                                ...
                                <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover">
                                    <span class="fs-2x fw-bold text-gray-800">Purchase Order #PO{{ str_pad($purchaseOrder->po_id,8,"0",STR_PAD_LEFT) }}</span>
                                </div>
                                <!--end::Input group-->
                            </div>
                            <!--end::Top-->
                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-10 mb-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="purchase_request" class="form-select mb-5" id="selectPR">
                                            <option value="{{ $purchaseOrder->po_prID }}" selected="selected">PR{{ str_pad($purchaseOrder->tb_purchaserequest->pr_id,8,"0",STR_PAD_LEFT) }}</option>
                                        </select>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row gx-10 mb-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group mb-5">
                                            <input name="payment_term" type="number" value="{{ $purchaseOrder->po_paymentTerm }}" class="form-control" placeholder="Payment Term">
                                ...
                                <div class="row gx-10 mb-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <textarea name="delivery_to" class="form-control form-control" rows="4" placeholder="Delivery To">{{ $purchaseOrder->po_deliveryTo }}</textarea>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row gx-10 mb-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <!--begin::Input group-->
                                            <input name="buyer" type="text" class="form-control" placeholder="Buyer" value="{{ $purchaseOrder->po_buyer }}">
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Col-->
                                </div>
