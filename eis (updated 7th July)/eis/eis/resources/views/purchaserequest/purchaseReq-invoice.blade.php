				                ...
				                <div class="mw-lg-950px mx-auto w-100" id="print-invoice">
				                    ...
				                    <div class="pb-12">
				                        ...
				                        <div class="d-flex flex-column gap-8 gap-md-5">
				                            ...
				                            <!--begin::Separator-->
				                            <!--begin::Order details-->
				                            <div class="text-sm-end font-weight-bold fs-3" align="right">
				                                <strong>PURCHASE REQUEST</strong>
				                            </div>
				                            <div class="text-sm-end font-weight-bold fs-6" align="right">
				                                <strong>PR{{ str_pad($pr->pr_id, 8, '0', STR_PAD_LEFT) }}</strong>
				                            </div>
				                            <div class="text-sm-end font-weight-bold fs-8 print-header">
												<table class="text-sm-end font-weight-bold fs-8" align="right">
													<tr>
														<td>CREATED DATE</td>
														<td style="width: 150px;">{{ $pr->pr_cdate->format('d-m-Y') }}</td>
													</tr>
													<tr>
													...
													<tr>
														<td>PAGE</td>
														<td style="width: 150px;">1 of 1</td>
													</tr>
												</table>
											</div>
				                            <!--end::Order details-->
