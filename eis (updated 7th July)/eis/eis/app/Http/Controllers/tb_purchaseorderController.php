...
class tb_purchaseorderController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $pr = tb_purchaserequest::with('tb_product')->findOrFail($request->input('purchase_request'));
        $purchaseOrder->po_supplierID = $pr->pr_supplierID;
        $purchaseOrder->po_total = $pr->tb_product->prod_price * $pr->pr_qty;
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        $purchaseOrder->po_prID = $request->input('purchase_request');
        $pr = tb_purchaserequest::findOrFail($request->input('purchase_request'));
        $purchaseOrder->po_supplierID = $pr->pr_supplierID;
        $purchaseOrder->po_total = $pr->tb_product->prod_price * $pr->pr_qty;
        $purchaseOrder->po_paymentTerm = $request->input('payment_term');
        $purchaseOrder->po_deliveryTo = $request->input('delivery_to');
