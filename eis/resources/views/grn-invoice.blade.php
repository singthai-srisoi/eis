				                    ...
				                    <div class="pb-12">
				                        ...
				                        <div class="d-flex flex-column gap-8 gap-md-5">
				                            ...
				                            <div class="text-sm-end font-weight-bold fs-8" align="right">
				                                ...
				                                <div>Purchase Order Number : PO{{str_pad($grn->grn_poid,8,"0",STR_PAD_LEFT)}}</div>
												<div>Customer Delivery Order Number : {{$grn->grn_deliveryOrderNum}}</div>
												<div>Customer Delivery Order Date : {{$grn->grn_deliverydate}}</div>
				                                <div>PAGE: 1 of 1</div>
				                            </div>
				                            <!--end::Order details-->
				                            <!--begin:Order summary-->
